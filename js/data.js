...
function generateAppointments() {
  ...
  const appointments = [
    ...
    { patient_id: 'P002', time: '12:00', reason: 'Diabetes check — HbA1c review', type: 'followup', status: 'scheduled' },
    { patient_id: 'P018', time: '13:00', reason: 'Thyroid — 3 week recheck', type: 'followup', status: 'scheduled' },
    // Evening OPD (6 PM – 9 PM)
    { patient_id: 'P003', time: '18:00', reason: 'Back pain — physiotherapy review', type: 'routine', status: 'scheduled' },
    { patient_id: 'P012', time: '18:30', reason: 'Anemia — iron infusion follow-up', type: 'followup', status: 'scheduled' },
    { patient_id: 'P007', time: '19:00', reason: 'Gastritis — endoscopy results', type: 'urgent', status: 'scheduled' },
    { patient_id: 'P010', time: '19:30', reason: 'PCOS — ultrasound review', type: 'followup', status: 'scheduled' },
    { patient_id: 'P020', time: '20:00', reason: 'Insomnia — sleep study results', type: 'routine', status: 'scheduled' },
    { patient_id: 'P016', time: '20:30', reason: 'Osteoporosis — DEXA scan review', type: 'followup', status: 'scheduled' },
    ...
    { patient_id: 'P010', time: '12:00', reason: 'PCOS follow-up — hormonal panel', type: 'followup', daysFromToday: 1, status: 'scheduled' },
    { patient_id: 'P015', time: '13:00', reason: 'Fatty liver — lifestyle review', type: 'followup', daysFromToday: 1, status: 'scheduled' },
    { patient_id: 'P008', time: '18:00', reason: 'Joint pain — MRI review', type: 'followup', daysFromToday: 1, status: 'scheduled' },
    { patient_id: 'P006', time: '18:30', reason: 'Migraine — trigger diary review', type: 'routine', daysFromToday: 1, status: 'scheduled' },
    { patient_id: 'P013', time: '19:00', reason: 'COPD — nebulizer technique check', type: 'routine', daysFromToday: 1, status: 'scheduled' },
    { patient_id: 'P001', time: '19:30', reason: 'BP — evening monitoring review', type: 'followup', daysFromToday: 1, status: 'scheduled' },
    { patient_id: 'P017', time: '20:30', reason: 'Peptic ulcer — H. pylori eradication check', type: 'followup', daysFromToday: 1, status: 'scheduled' },
    ...
    { patient_id: 'P010', time: '13:00', reason: 'Anxiety — SSRI response check', type: 'followup', daysFromToday: 2, status: 'scheduled' },
    { patient_id: 'P012', time: '18:00', reason: 'Anemia — ferritin recheck', type: 'routine', daysFromToday: 2, status: 'scheduled' },
    { patient_id: 'P005', time: '18:30', reason: 'Asthma — inhaler technique check', type: 'routine', daysFromToday: 2, status: 'scheduled' },
    { patient_id: 'P019', time: '19:00', reason: 'Retinopathy — visual acuity test', type: 'urgent', daysFromToday: 2, status: 'scheduled' },
    { patient_id: 'P009', time: '19:30', reason: 'AF — pulse rate monitoring', type: 'followup', daysFromToday: 2, status: 'scheduled' },
    { patient_id: 'P020', time: '20:00', reason: 'Depression — therapy progress', type: 'routine', daysFromToday: 2, status: 'scheduled' },
    ...
    { patient_id: 'P020', time: '12:30', reason: 'New patient — depression screening', type: 'routine', daysFromToday: 3, status: 'scheduled' },
    { patient_id: 'P002', time: '18:00', reason: 'Diabetes — foot exam', type: 'routine', daysFromToday: 3, status: 'scheduled' },
    { patient_id: 'P015', time: '18:30', reason: 'Fatty liver — diet counseling', type: 'followup', daysFromToday: 3, status: 'scheduled' },
    { patient_id: 'P011', time: '19:00', reason: 'CKD — diet and fluid management', type: 'urgent', daysFromToday: 3, status: 'scheduled' },
    { patient_id: 'P004', time: '19:30', reason: 'Knee pain — physiotherapy assessment', type: 'followup', daysFromToday: 3, status: 'scheduled' },
    ...
    { patient_id: 'P004', time: '12:30', reason: 'Knee X-ray results', type: 'followup', daysFromToday: 4, status: 'scheduled' },
    { patient_id: 'P016', time: '18:00', reason: 'Osteoporosis — calcium review', type: 'routine', daysFromToday: 4, status: 'scheduled' },
    { patient_id: 'P018', time: '18:30', reason: 'Thyroid — TSH recheck', type: 'followup', daysFromToday: 4, status: 'scheduled' },
    { patient_id: 'P013', time: '19:00', reason: 'COPD — oxygen therapy review', type: 'urgent', daysFromToday: 4, status: 'scheduled' },
    { patient_id: 'P003', time: '20:00', reason: 'Back pain — evening check-in', type: 'routine', daysFromToday: 4, status: 'scheduled' },
    ...
    { patient_id: 'P013', time: '12:00', reason: 'COPD — spirometry follow-up', type: 'followup', daysFromToday: 5, status: 'scheduled' },
    { patient_id: 'P014', time: '18:00', reason: 'RA — joint mobility assessment', type: 'followup', daysFromToday: 5, status: 'scheduled' },
    { patient_id: 'P001', time: '19:00', reason: 'BP — ambulatory monitoring review', type: 'urgent', daysFromToday: 5, status: 'scheduled' },
    { patient_id: 'P019', time: '19:30', reason: 'Retinopathy — fundus review', type: 'followup', daysFromToday: 5, status: 'scheduled' },

    // ── Next week ────────────────────────────
    { patient_id: 'P004', time: '10:00', reason: 'Knee injection follow-up', type: 'followup', daysFromToday: 7, status: 'scheduled' },
    { patient_id: 'P001', time: '18:30', reason: '24hr BP monitoring review', type: 'urgent', daysFromToday: 7, status: 'scheduled' },
    ...
    { patient_id: 'P007', time: '19:00', reason: 'Gastritis — probiotic response', type: 'routine', daysFromToday: 7, status: 'scheduled' },
    { patient_id: 'P020', time: '19:30', reason: 'Depression — SSRI dose adjustment', type: 'followup', daysFromToday: 7, status: 'scheduled' },
    ...
    { patient_id: 'P020', time: '18:00', reason: 'New patient — depression + insomnia', type: 'routine', daysFromToday: 8, status: 'scheduled' },
    { patient_id: 'P012', time: '18:30', reason: 'Anemia — dietary counseling', type: 'routine', daysFromToday: 8, status: 'scheduled' },
    { patient_id: 'P005', time: '19:00', reason: 'Asthma — peak flow review', type: 'followup', daysFromToday: 8, status: 'scheduled' },
    ...
    { patient_id: 'P019', time: '18:30', reason: 'Diabetic retinopathy — post anti-VEGF', type: 'urgent', daysFromToday: 9, status: 'scheduled' },
    { patient_id: 'P015', time: '19:30', reason: 'Fatty liver — fibroscan results', type: 'followup', daysFromToday: 9, status: 'scheduled' },
    ...
    { patient_id: 'P003', time: '18:00', reason: 'Back pain — MRI review', type: 'urgent', daysFromToday: 10, status: 'scheduled' },
    ...
    { patient_id: 'P010', time: '18:30', reason: 'PCOS — weight management review', type: 'followup', daysFromToday: 11, status: 'scheduled' },
    { patient_id: 'P004', time: '19:00', reason: 'TSH recheck + ortho referral', type: 'followup', daysFromToday: 14, status: 'scheduled' },
    ...
    { patient_id: 'P008', time: '18:00', reason: 'Joint pain — long-term management', type: 'routine', daysFromToday: 14, status: 'scheduled' },
  ];
